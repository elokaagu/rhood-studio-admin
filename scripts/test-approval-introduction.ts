...
const checks: Array<[string, boolean]> = [
  ...
  ["html tells them all communication stays on the thread", /All communication stays here/i.test(built.html) && /as R\/HOOD/.test(built.html)],
  ["html names hello@rhood.io as R/HOOD", built.html.includes(CAMPAIGN_AGENT_EMAIL) && /R\/HOOD agent/i.test(built.html) === false],
