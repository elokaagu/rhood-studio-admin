-- Complete Brand Portal & Invite Code System Setup
-- Run this single migration to set up everything in the correct order
...
-- ============================================
-- STEP 2: Add brand_name column to user_profiles
-- ============================================
ALTER TABLE public.user_profiles 
